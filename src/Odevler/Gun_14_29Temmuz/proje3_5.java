...
public class proje3_5 extends BaseStaticDriver {
...
//SCENARIO 5:
        ...
        driver.findElement(By.cssSelector("input[name='cardnumber']")).sendKeys("4242 4242 4242 4242");//-Enter Card number as "4242 4242 4242 4242"
        Bekle(1); //adımı görmek için

        driver.findElement(By.cssSelector("input[placeholder='AA / YY']")).sendKeys("12/22");//-Enter Expiration as "12/22" and CVV as "000"
        driver.findElement(By.cssSelector("input[placeholder='CVC']")).sendKeys("000");//-Enter Expiration as "12/22" and CVV as "000"
        Bekle(2); //adımı görmek için
        driver.switchTo().parentFrame(); // geldiği yere geri dön(1 basamak geri git)
        driver.findElement(By.cssSelector("button[class='Pay-Button']")).click();//-Click on 'Pay using Debit Card'
        driver.switchTo().defaultContent();
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector("p[class='confirme_text']"))));//wait

        Assert.assertTrue(driver.getPageSource().contains(" your order is confirmed. Thank you!")); //-Validate cart item no is '1'
